...
export const AppAiPromptContextSchema = z.object({
...
export const AppAiDescriptionInputSchema = z.object({
  item: AppAiPromptContextSchema,
})

export const AppAiPricePromptContextSchema = z.object({
  title: z.string().nonempty(),
  description: z.string().optional(),
  price: z.number().min(0).optional(),
  category: z.string().nonempty(),
...
export const AppAiPriceInputSchema = z.object({
  item: AppAiPricePromptContextSchema,
})
